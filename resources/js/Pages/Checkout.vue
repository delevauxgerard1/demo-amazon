...
onMounted(() => {
    stripe = Stripe("pk_test_51OZ3Q2INGzVfUHrBwZW85c5IMFL4kBXCUzZrgmPnInLGV5NLaezXufD7sk0yM1E7YCZpgUYJLyzbseWXEA8VBL08000xHNjDUr");
        ...
        <div class="flex max-w-[1250px] mx-auto pt-4">
            ...
            <div class="w-8/12">
                <div class="flex items-stretch border-b border-b-gray-300 w-[calc(100%-100px)] pb-4 pl-4 mb-6">
                    ...
                    <div class="px-4 font-semibold">
                        ...
                        <div v-if="$page.props.auth.address">
                        ...
                        <!-- Mostrar el enlace si la dirección no está presente -->
                        <div v-else>
                            <Link :href="route('address.index')" class="text-blue-700">
                            Add address
                            </Link>
                        </div>
                    </div>
            ...
            <div class="w-4/12 border border-gray-400 rounded-md py-4 px-2">
                ...
                <form id="payment-form">
                    ...
                    <button id="submit" :disabled="!$page.props.auth.address"
                        :style="{ opacity: $page.props.auth.address ? 1 : 0.5 }"
                    ...
                    <p v-if="!$page.props.auth.address" class="text-red-700 text-center mt-2 font-semibold">
